...
- generic [active] [ref=f11e1]:
  ...
  - generic [ref=f11e39]:
    - generic [ref=f11e41]:
      ...
      - generic [ref=f11e43]:
        - textbox "Email Address" [ref=f11e44]: maria123@gmail.com
        - textbox "Password" [ref=f11e45]: password789
  ...
  - insertion [ref=f11e74]:
    - generic [ref=f11e77]:
      ...
      - link "API documentation" [ref=f11e80] [cursor=pointer]
      - link "Automation consulting" [ref=f11e85] [cursor=pointer]
      - link "Test case design" [ref=f11e90] [cursor=pointer]
```

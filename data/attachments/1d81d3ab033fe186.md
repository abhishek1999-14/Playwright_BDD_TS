...
- generic [active] [ref=f11e1]:
  ...
  - generic [ref=f11e39]:
    ...
    - generic [ref=f11e50]:
      ...
      - generic [ref=f11e52]:
        - textbox "Name" [ref=f11e53]: Maria Garci
        - textbox "Email Address" [ref=f11e54]: maria123@gmail.com
  ...
  - insertion [ref=f11e74]:
    - generic [ref=f11e77]:
      ...
      - link "Technical Reference" [ref=f11e80] [cursor=pointer]
      - link "Computer Security" [ref=f11e85] [cursor=pointer]
      - link "API development resources" [ref=f11e90] [cursor=pointer]
```
